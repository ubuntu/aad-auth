...
#[test_case(Some("users_in_db".to_string()), false, -1, NssStatus::Success; "Successfully retrieves all entries without access to shadow")]
...
#[test_case("myuser@domain.com", Some("users_in_db".to_string()), false, -1, NssStatus::Success; "Successfully retrieves existing entry without access to shadow")]
