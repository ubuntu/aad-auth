...
//go:generate go run generate-locales.go update-po ../../po/aad-auth.pot ../../po
//go:generate go run generate-locales.go generate-mo aad-auth ../../po ../../generated
...
func (l *i18n) bindTextDomain(domain, dir string) {
	l.translations = &gettext.TextDomain{Name: domain, LocaleDir: dir, PathResolver: langpackResolver}
}
