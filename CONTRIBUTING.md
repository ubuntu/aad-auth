...
* To report security vulnerabilities, please use [launchpad AAD Auth private bugs](https://bugs.launchpad.net/ubuntu/+source/aad-auth/+filebug) which is monitored by our security team. On ubuntu machine, it’s best to use `ubuntu-bug aad-auth` to collect relevant information.
...
* Include documentation in the repo or on our [docs site](https://github.com/ubuntu/aad-auth/wiki).
